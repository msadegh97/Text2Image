...
/home/hlcv_team019/miniconda3/envs/myenv1/bin/python train.py --experiment_name "WGAN_BIRDS_CLS_emb" --num_epochs 601 --log_interval 200 --lr 0.0001 --ngpu 1 --dataset birds --num_workers 8 --wandb=True --cls=True
