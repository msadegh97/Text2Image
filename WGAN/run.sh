...
/home/hlcv_team019/miniconda3/envs/myenv1/bin/python train.py --experiment_name "WGAN_BIRDS_CLS2" --num_epochs 300 --log_interval 100 --lr 0.00005 --ngpu 1 --dataset birds --num_workers 8 --wandb=True --cls=True
