...
/home/hlcv_team019/miniconda3/envs/myenv1/bin/python train.py --experiment_name "GGAN_INT_BIRDS" --num_epochs 600 --log_interval 100 --ngpu 1 --dataset birds --num_workers 8 --wandb=True --cls=False
